function Y = sortCellArr(X, DIM)
% sortCellArr    Sort a cell array in ascending order.
%
% Description: sortCellArr sorts the input cell array according to the
%   dimensions (columns) specified by the user.
%
% Usage: Y = sortCellArr(X, DIM)
%
% Input:
...
% If it is then use recursion to call the sortCellArr function again to sort
% the less important columns first. Repeat calls to sortCellArr until only one
