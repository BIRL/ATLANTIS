...
path = ['Supplementary Functions', filesep, 'Images', filesep];
...
if directory == 0
    ...
    % ERROR DLG
    enableDisableFig(findall(0, 'tag','NetworkInputMenu2'), 'off');
    ...
    enableDisableFig(findall(0, 'tag','NetworkInputMenu2'), 'on');
    bringToFocus(findall(0, 'tag','NetworkInputMenu2'));
    return;
end
