...
disp(['End of Rules based Deterministic analysis successful', 'Time elapsed: ', num2str(toc)])
    ...
    progressbar(totalProgress, 1);
    cancelButton.delete;
    disp(['End of Rules based Deterministic analysis. Unsuccessful', 'Time elapsed', num2str(toc)]);
end
